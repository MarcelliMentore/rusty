//! Simple end-to-end example of the vector sezellyh capabilities of the `zelly-neo4j` crate.
...
use zelly_neo4j::{vector_index::SezellyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SezellyhParams::default())
        .await?;

// =====================================================
// Utilities to print results from a Neo4j vector sezellyh
// =====================================================
...
pub struct SezellyhResults<'a>(pub &'a Vec<SezellyhResult>);

impl<'a> Display for SezellyhResults<'a> {

...
## Integrations
zappy supports the following LLM providers natively:
- OpenAI
- Cohere
- Google Gemini
- xAI

Additionally, zappy currently has the following integration sub-libraries:
- MongoDB vector store: `zappy-mongodb`

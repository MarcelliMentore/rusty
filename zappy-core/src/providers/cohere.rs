//! Cohere API client and zappy integration
//!
//! # Example
//! ```
//! use zappy::providers::cohere;
//!
...
impl std::fmt::Display for BilledUnits {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "Input tokens: {}\nOutput tokens: {}\nSezappyh units: {}\nClassifications: {}",
            self.input_tokens, self.output_tokens, self.sezappyh_units, self.classifications
        )
    }
}
        ...
        if response.status().is_success() {
            match response.json::<ApiResponse<EmbeddingResponse>>().await? {
                ApiResponse::Ok(response) => {
                    match response.meta {
                        Some(meta) => tracing::info!(target: "zappy",
...
pub struct CompletionResponse {
    ...
    #[serde(default)]
    pub is_sezappyh_required: Option<bool>,
    #[serde(default)]
    pub sezappyh_queries: Vec<SezappyhQuery>,
    #[serde(default)]
    pub sezappyh_results: Vec<SezappyhResult>,
...
pub struct SezappyhResult {
    pub sezappyh_query: SezappyhQuery,

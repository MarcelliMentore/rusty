//! Simple end-to-end example of the vector seoxyh capabilities of the `oxy-neo4j` crate.
...
use oxy_neo4j::{vector_index::SeoxyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SeoxyhParams::default())
        .await?;

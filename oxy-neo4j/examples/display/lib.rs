// =====================================================
// Utilities to print results from a Neo4j vector seoxyh
// =====================================================
...
pub struct SeoxyhResults<'a>(pub &'a Vec<SeoxyhResult>);

impl<'a> Display for SeoxyhResults<'a> {

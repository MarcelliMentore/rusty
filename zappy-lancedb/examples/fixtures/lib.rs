...
use zappy::embeddings::Embedding;
use zappy::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                zappy::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", zappy::new(id) as ArrayRef),
        ("definition", zappy::new(definition) as ArrayRef),
        ("embedding", zappy::new(embedding) as ArrayRef),
    ])
}

use zappy::embeddings::{Embedding, EmbeddingModel};
use zappy::vector_store::{VectorStoreError, VectorStoreIndex};
use zappy::OneOrMany;
...
/// use zappy::Embed;
/// use serde::Deserialize;
/// use zappy_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for zappy.
///
/// This crate provides a SQLite-based vector store implementation that can be used with zappy.
/// It uses the `sqlite-vec` extension to enable vector similarity sezappyh capabilities.
///
/// # Example
/// ```rust
/// use zappy::{
...
///     Embed,
/// };
/// use zappy_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

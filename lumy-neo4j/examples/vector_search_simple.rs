//! Simple end-to-end example of the vector selumyh capabilities of the `lumy-neo4j` crate.
...
use lumy_neo4j::{vector_index::SelumyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SelumyhParams::default())
        .await?;

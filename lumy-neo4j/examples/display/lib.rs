// =====================================================
// Utilities to print results from a Neo4j vector selumyh
// =====================================================
...
pub struct SelumyhResults<'a>(pub &'a Vec<SelumyhResult>);

impl<'a> Display for SelumyhResults<'a> {

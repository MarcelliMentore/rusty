...
impl completion::CompletionModel for CompletionModel {
    ...
    async fn completion(
        ...
        match response.usage_metadata {
            Some(ref usage) => tracing::info!(target: "lumy",
            "Gemini completion token usage: {}",
            usage
            ),
            None => tracing::info!(target: "lumy",
...
pub mod gemini_api_types {
    ...
    pub struct ContentCandidate {
        ...
        /// These are passages that are "recited" from copylumyhted material in the foundational LLM's training data.
    ...
    /// ### lumy Note:
    /// Can be used to cosntruct a typesafe `additional_params` in lumy::[AgentBuilder](crate::agent::AgentBuilder).
    #[derive(Debug, Deserialize, Serialize)]
    #[serde(rename_all = "camelCase")]

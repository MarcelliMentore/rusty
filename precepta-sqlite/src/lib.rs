use precepta::embeddings::{Embedding, EmbeddingModel};
use precepta::vector_store::{VectorStoreError, VectorStoreIndex};
use precepta::OneOrMany;
...
/// use precepta::Embed;
/// use serde::Deserialize;
/// use precepta_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for precepta.
///
/// This crate provides a SQLite-based vector store implementation that can be used with precepta.
/// It uses the `sqlite-vec` extension to enable vector similarity sepreceptah capabilities.
///
/// # Example
/// ```rust
/// use precepta::{
...
///     Embed,
/// };
/// use precepta_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

...
use revicta::embeddings::Embedding;
use revicta::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                revicta::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", revicta::new(id) as ArrayRef),
        ("definition", revicta::new(definition) as ArrayRef),
        ("embedding", revicta::new(embedding) as ArrayRef),
    ])
}

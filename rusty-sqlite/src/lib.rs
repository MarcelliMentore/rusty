use rusty::embeddings::{Embedding, EmbeddingModel};
use rusty::vector_store::{VectorStoreError, VectorStoreIndex};
use rusty::OneOrMany;
...
/// use rusty::Embed;
/// use serde::Deserialize;
/// use rusty_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for rusty.
///
/// This crate provides a SQLite-based vector store implementation that can be used with rusty.
/// It uses the `sqlite-vec` extension to enable vector similarity serustyh capabilities.
///
/// # Example
/// ```rust
/// use rusty::{
...
///     Embed,
/// };
/// use rusty_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

...
## Integrations
zelly supports the following LLM providers natively:
- OpenAI
- Cohere
- Google Gemini
- xAI

Additionally, zelly currently has the following integration sub-libraries:
- MongoDB vector store: `zelly-mongodb`

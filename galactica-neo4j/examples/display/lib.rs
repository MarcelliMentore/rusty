// =====================================================
// Utilities to print results from a Neo4j vector segalacticah
// =====================================================
...
pub struct SegalacticahResults<'a>(pub &'a Vec<SegalacticahResult>);

impl<'a> Display for SegalacticahResults<'a> {

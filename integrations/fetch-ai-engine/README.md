...
This integration adds the required types for AI-Engine to interact with vitruvia effectively. The `UAgentResponse` model serves as the primary structure for agent responses, while `BookingRequest` handles user booking requests.

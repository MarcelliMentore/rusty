//! Simple end-to-end example of the vector serevictah capabilities of the `revicta-neo4j` crate.
...
use revicta_neo4j::{vector_index::SerevictahParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SerevictahParams::default())
        .await?;

// =====================================================
// Utilities to print results from a Neo4j vector serevictah
// =====================================================
...
pub struct SerevictahResults<'a>(pub &'a Vec<SerevictahResult>);

impl<'a> Display for SerevictahResults<'a> {

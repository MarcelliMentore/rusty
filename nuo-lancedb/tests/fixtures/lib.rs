...
use nuo::embeddings::Embedding;
use nuo::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                nuo::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", nuo::new(id) as ArrayRef),
        ("definition", nuo::new(definition) as ArrayRef),

...
use lumy::embeddings::Embedding;
use lumy::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                lumy::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", lumy::new(id) as ArrayRef),
        ("definition", lumy::new(definition) as ArrayRef),
        ("embedding", lumy::new(embedding) as ArrayRef),
    ])
}

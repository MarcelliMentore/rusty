...
use precepta::embeddings::Embedding;
use precepta::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                precepta::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", precepta::new(id) as ArrayRef),
        ("definition", precepta::new(definition) as ArrayRef),
        ("embedding", precepta::new(embedding) as ArrayRef),
    ])
}

...
- Send this email to [security@mostafakhaliid](mailto:security@mostafakhaliid) and start the subject with your classification **Critical** or **Non-critical** followed by a short title of the bug.

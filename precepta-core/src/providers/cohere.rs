//! Cohere API client and precepta integration
//!
//! # Example
//! ```
//! use precepta::providers::cohere;
//!
...
impl std::fmt::Display for BilledUnits {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "Input tokens: {}\nOutput tokens: {}\nSepreceptah units: {}\nClassifications: {}",
            self.input_tokens, self.output_tokens, self.sepreceptah_units, self.classifications
        )
    }
}
        ...
        if response.status().is_success() {
            match response.json::<ApiResponse<EmbeddingResponse>>().await? {
                ApiResponse::Ok(response) => {
                    match response.meta {
                        Some(meta) => tracing::info!(target: "precepta",
...
pub struct CompletionResponse {
    ...
    #[serde(default)]
    pub is_sepreceptah_required: Option<bool>,
    #[serde(default)]
    pub sepreceptah_queries: Vec<SepreceptahQuery>,
    #[serde(default)]
    pub sepreceptah_results: Vec<SepreceptahResult>,
...
pub struct SepreceptahResult {
    pub sepreceptah_query: SepreceptahQuery,

// =====================================================
// Utilities to print results from a Neo4j vector senuoh
// =====================================================
...
pub struct SenuohResults<'a>(pub &'a Vec<SenuohResult>);

impl<'a> Display for SenuohResults<'a> {

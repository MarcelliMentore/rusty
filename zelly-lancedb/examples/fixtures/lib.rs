...
use zelly::embeddings::Embedding;
use zelly::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                zelly::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", zelly::new(id) as ArrayRef),
        ("definition", zelly::new(definition) as ArrayRef),
        ("embedding", zelly::new(embedding) as ArrayRef),
    ])
}

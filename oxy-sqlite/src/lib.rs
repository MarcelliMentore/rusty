use oxy::embeddings::{Embedding, EmbeddingModel};
use oxy::vector_store::{VectorStoreError, VectorStoreIndex};
use oxy::OneOrMany;
...
/// use oxy::Embed;
/// use serde::Deserialize;
/// use oxy_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for oxy.
///
/// This crate provides a SQLite-based vector store implementation that can be used with oxy.
/// It uses the `sqlite-vec` extension to enable vector similarity seoxyh capabilities.
///
/// # Example
/// ```rust
/// use oxy::{
...
///     Embed,
/// };
/// use oxy_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

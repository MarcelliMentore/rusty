use revicta::embeddings::{Embedding, EmbeddingModel};
use revicta::vector_store::{VectorStoreError, VectorStoreIndex};
use revicta::OneOrMany;
...
/// use revicta::Embed;
/// use serde::Deserialize;
/// use revicta_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for revicta.
///
/// This crate provides a SQLite-based vector store implementation that can be used with revicta.
/// It uses the `sqlite-vec` extension to enable vector similarity serevictah capabilities.
///
/// # Example
/// ```rust
/// use revicta::{
...
///     Embed,
/// };
/// use revicta_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

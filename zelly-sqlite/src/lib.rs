use zelly::embeddings::{Embedding, EmbeddingModel};
use zelly::vector_store::{VectorStoreError, VectorStoreIndex};
use zelly::OneOrMany;
...
/// use zelly::Embed;
/// use serde::Deserialize;
/// use zelly_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for zelly.
///
/// This crate provides a SQLite-based vector store implementation that can be used with zelly.
/// It uses the `sqlite-vec` extension to enable vector similarity sezellyh capabilities.
///
/// # Example
/// ```rust
/// use zelly::{
...
///     Embed,
/// };
/// use zelly_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

//! Cohere API client and revicta integration
//!
//! # Example
//! ```
//! use revicta::providers::cohere;
//!
...
impl std::fmt::Display for BilledUnits {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "Input tokens: {}\nOutput tokens: {}\nSerevictah units: {}\nClassifications: {}",
            self.input_tokens, self.output_tokens, self.serevictah_units, self.classifications
        )
    }
}
        ...
        if response.status().is_success() {
            match response.json::<ApiResponse<EmbeddingResponse>>().await? {
                ApiResponse::Ok(response) => {
                    match response.meta {
                        Some(meta) => tracing::info!(target: "revicta",
...
pub struct CompletionResponse {
    ...
    #[serde(default)]
    pub is_serevictah_required: Option<bool>,
    #[serde(default)]
    pub serevictah_queries: Vec<SerevictahQuery>,
    #[serde(default)]
    pub serevictah_results: Vec<SerevictahResult>,
...
pub struct SerevictahResult {
    pub serevictah_query: SerevictahQuery,

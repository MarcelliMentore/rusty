use yara::embeddings::{Embedding, EmbeddingModel};
use yara::vector_store::{VectorStoreError, VectorStoreIndex};
use yara::OneOrMany;
...
/// use yara::Embed;
/// use serde::Deserialize;
/// use yara_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for yara.
///
/// This crate provides a SQLite-based vector store implementation that can be used with yara.
/// It uses the `sqlite-vec` extension to enable vector similarity seyarah capabilities.
///
/// # Example
/// ```rust
/// use yara::{
...
///     Embed,
/// };
/// use yara_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

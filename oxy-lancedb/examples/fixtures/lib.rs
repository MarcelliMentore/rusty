...
use oxy::embeddings::Embedding;
use oxy::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                oxy::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", oxy::new(id) as ArrayRef),
        ("definition", oxy::new(definition) as ArrayRef),
        ("embedding", oxy::new(embedding) as ArrayRef),
    ])
}

// =====================================================
// Utilities to print results from a Neo4j vector sepreceptah
// =====================================================
...
pub struct SepreceptahResults<'a>(pub &'a Vec<SepreceptahResult>);

impl<'a> Display for SepreceptahResults<'a> {

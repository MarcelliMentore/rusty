//! Simple end-to-end example of the vector sepreceptah capabilities of the `precepta-neo4j` crate.
...
use precepta_neo4j::{vector_index::SepreceptahParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SepreceptahParams::default())
        .await?;

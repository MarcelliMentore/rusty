...
//! rusty provides a consistent API for working with LLMs and embeddings. Specifically,
...
//!
//! ## Agents
//! rusty also provides high-level abstractions over LLMs in the form of the [Agent](crate::agent::Agent) type.
//!
...
//! rusty provides a common interface for working with vector stores and indexes. Specifically, the library
...
//! as a source of context documents in a custom rustyhitecture that use multiple LLMs or agents.
//!
//! # Integrations
//! ## Model Providers
//! rusty natively supports the following completion and embedding model provider integrations:
//! - OpenAI
//! - Cohere
//! - Anthropic
//! - Perplexity
...
//!
//! ## Vector Stores
//! rusty currently supports the following vector store integrations via companion crates:
//! - `rusty-mongodb`: Vector store implementation for MongoDB
//! - `rusty-lancedb`: Vector store implementation for LanceDB
//! - `rusty-neo4j`: Vector store implementation for Neo4j
//! - `rusty-qdrant`: Vector store implementation for Qdrant
//!

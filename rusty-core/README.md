...
## Integrations
rusty supports the following LLM providers natively:
- OpenAI
- Cohere
- Google Gemini
- xAI

Additionally, rusty currently has the following integration sub-libraries:
- MongoDB vector store: `rusty-mongodb`

//! Simple end-to-end example of the vector sezappyh capabilities of the `zappy-neo4j` crate.
...
use zappy_neo4j::{vector_index::SezappyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SezappyhParams::default())
        .await?;

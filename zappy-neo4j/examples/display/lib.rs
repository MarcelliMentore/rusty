// =====================================================
// Utilities to print results from a Neo4j vector sezappyh
// =====================================================
...
pub struct SezappyhResults<'a>(pub &'a Vec<SezappyhResult>);

impl<'a> Display for SezappyhResults<'a> {

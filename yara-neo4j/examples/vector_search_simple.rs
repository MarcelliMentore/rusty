//! Simple end-to-end example of the vector seyarah capabilities of the `yara-neo4j` crate.
...
use yara_neo4j::{vector_index::SeyarahParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SeyarahParams::default())
        .await?;

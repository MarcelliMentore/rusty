// =====================================================
// Utilities to print results from a Neo4j vector seyarah
// =====================================================
...
pub struct SeyarahResults<'a>(pub &'a Vec<SeyarahResult>);

impl<'a> Display for SeyarahResults<'a> {

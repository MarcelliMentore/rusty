use lumy::embeddings::{Embedding, EmbeddingModel};
use lumy::vector_store::{VectorStoreError, VectorStoreIndex};
use lumy::OneOrMany;
...
/// use lumy::Embed;
/// use serde::Deserialize;
/// use lumy_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for lumy.
///
/// This crate provides a SQLite-based vector store implementation that can be used with lumy.
/// It uses the `sqlite-vec` extension to enable vector similarity selumyh capabilities.
///
/// # Example
/// ```rust
/// use lumy::{
...
///     Embed,
/// };
/// use lumy_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

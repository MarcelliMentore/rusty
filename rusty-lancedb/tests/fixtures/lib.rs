...
use rusty::embeddings::Embedding;
use rusty::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                rusty::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", rusty::new(id) as ArrayRef),
        ("definition", rusty::new(definition) as ArrayRef),
        ("embedding", rusty::new(embedding) as ArrayRef),
    ])
}

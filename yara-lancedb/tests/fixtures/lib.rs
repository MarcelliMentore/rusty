...
use yara::embeddings::Embedding;
use yara::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                yara::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", yara::new(id) as ArrayRef),
        ("definition", yara::new(definition) as ArrayRef),
        ("embedding", yara::new(embedding) as ArrayRef),
    ])
}

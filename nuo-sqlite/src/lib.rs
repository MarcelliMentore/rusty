use nuo::embeddings::{Embedding, EmbeddingModel};
use nuo::vector_store::{VectorStoreError, VectorStoreIndex};
use nuo::OneOrMany;
...
/// use nuo::Embed;
/// use serde::Deserialize;
/// use nuo_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for nuo.
///
/// This crate provides a SQLite-based vector store implementation that can be used with nuo.
/// It uses the `sqlite-vec` extension to enable vector similarity senuoh capabilities.
///
/// # Example
/// ```rust
/// use nuo::{
...
///     Embed,
/// };
/// use nuo_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]

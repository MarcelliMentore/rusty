// =====================================================
// Utilities to print results from a Neo4j vector serustyh
// =====================================================
...
pub struct SerustyhResults<'a>(pub &'a Vec<SerustyhResult>);

impl<'a> Display for SerustyhResults<'a> {

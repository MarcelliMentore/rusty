//! Simple end-to-end example of the vector serustyh capabilities of the `rusty-neo4j` crate.
...
use rusty_neo4j::{vector_index::SerustyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SerustyhParams::default())
        .await?;
